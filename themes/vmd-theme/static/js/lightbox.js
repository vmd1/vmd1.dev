const initLightbox = () => {
    // Only create lightbox if it doesn't exist
    ...
    contentImages.forEach(img => {
        if (img.classList.contains('cursor-zoom-in')) return; // Already initialized
...
document.addEventListener('page:loaded', initLightbox);
